"""
Django settings for cniche project.
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',
    'https://www.caniche.irish',
    'https://canichesurveys.pythonanywhere.com'
]

ROOT_URLCONF = 'cniche.urls'
SITE_ID = 1
...
WSGI_APPLICATION = 'cniche.wsgi.application'
